def isPointinPolygon(point, rangelist):  # [[0,0],[1,1],[0,1],[0,0]] [1,0.8]
    ...
    print('lnglist, latlist', lnglist, latlist)
    maxlng = max(lnglist)
    minlng = min(lnglist)
    maxlat = max(latlist)
    minlat = min(latlist)
    print('maxlng, minlng, maxlat, minlat', maxlng, minlng, maxlat, minlat)
...
if __name__ == '__main__':
    print(isPointinPolygon([0.5, 0.5], [[0, 0], [0, 1], [1, 0], [1, 1]]))
